...
#define ST7920_DC_PIN   LCD_PINS_D6
...
#define ST7920_CS()              { WRITE(ST7920_CS_PIN,0); U8G_DELAY(); }
#define ST7920_NCS()             { WRITE(ST7920_CS_PIN,1); }
#define ST7920_SET_CMD()         { WRITE(ST7920_DC_PIN,0); U8G_DELAY(); }
#define ST7920_SET_DAT()         { WRITE(ST7920_DC_PIN,1); U8G_DELAY(); }
//#define ST7920_WRITE_BYTE(a)     { ST7920_SWSPI_SND_8BIT((uint8_t)((a)&0xF0u)); ST7920_SWSPI_SND_8BIT((uint8_t)((a)<<4U)); U8G_DELAY(); }
//#define ST7920_WRITE_BYTES(p,l)  { for (uint8_t i = l + 1; --i;) { ST7920_SWSPI_SND_8BIT(*p&0xF0); ST7920_SWSPI_SND_8BIT(*p<<4); p++; } U8G_DELAY(); }
#define ST7920_WRITE_BYTE(a)     {ST7920_SWSPI_SND_8BIT(a);U8G_DELAY();}
#define ST7920_WRITE_BYTES(p,l)  {uint8_t i;for(i=0;i<l;i++){ST7920_SWSPI_SND_8BIT(*p);p++;}U8G_DELAY();}